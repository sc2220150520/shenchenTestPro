...
@interface UIImage (LDAnimatedGIF)
 ...
 */
+ (UIImage * _Nullable)ld_animatedImageWithAnimatedGIFData:(NSData * _Nonnull)theData;
 ...
 */
+ (UIImage * _Nullable)ld_animatedImageWithAnimatedGIFURL:(NSURL * _Nonnull)theURL;
