...
static NSString *completeRPCURLPath = @"/ldwebviewprogressproxy/complete";

const float LDInitialProgressValue = 0.1f;
const float LDInteractiveProgressValue = 0.5f;
const float LDFinalProgressValue = 0.9f;

@implementation LDWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < LDInitialProgressValue) {
        [self setProgress:LDInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? LDFinalProgressValue : LDInteractiveProgressValue;
